...
ALTER SCHEMA public OWNER TO sandbox;
...
ALTER DOMAIN public."bıgınt" OWNER TO sandbox;
...
ALTER TYPE public.mpaa_rating OWNER TO sandbox;
...
ALTER DOMAIN public.year OWNER TO sandbox;
...
ALTER FUNCTION public._group_concat(text, text) OWNER TO sandbox;
...
ALTER FUNCTION public.film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO sandbox;
...
ALTER FUNCTION public.film_not_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO sandbox;
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp with time zone) OWNER TO sandbox;
...
ALTER FUNCTION public.inventory_held_by_customer(p_inventory_id integer) OWNER TO sandbox;
...
ALTER FUNCTION public.inventory_in_stock(p_inventory_id integer) OWNER TO sandbox;
...
ALTER FUNCTION public.last_day(timestamp with time zone) OWNER TO sandbox;
...
ALTER FUNCTION public.last_updated() OWNER TO sandbox;
...
ALTER TABLE public.customer_customer_id_seq OWNER TO sandbox;
...
ALTER TABLE public.customer OWNER TO sandbox;
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO sandbox;
...
ALTER AGGREGATE public.group_concat(text) OWNER TO sandbox;
...
ALTER TABLE public.actor_actor_id_seq OWNER TO sandbox;
...
ALTER TABLE public.actor OWNER TO sandbox;
...
ALTER TABLE public.category_category_id_seq OWNER TO sandbox;
...
ALTER TABLE public.category OWNER TO sandbox;
...
ALTER TABLE public.film_film_id_seq OWNER TO sandbox;
...
ALTER TABLE public.film OWNER TO sandbox;
...
ALTER TABLE public.film_actor OWNER TO sandbox;
...
ALTER TABLE public.film_category OWNER TO sandbox;
...
ALTER TABLE public.actor_info OWNER TO sandbox;
...
ALTER TABLE public.address_address_id_seq OWNER TO sandbox;
...
ALTER TABLE public.address OWNER TO sandbox;
...
ALTER TABLE public.city_city_id_seq OWNER TO sandbox;
...
ALTER TABLE public.city OWNER TO sandbox;
...
ALTER TABLE public.country_country_id_seq OWNER TO sandbox;
...
ALTER TABLE public.country OWNER TO sandbox;
...
ALTER TABLE public.customer_list OWNER TO sandbox;
...
ALTER TABLE public.film_list OWNER TO sandbox;
...
ALTER TABLE public.inventory_inventory_id_seq OWNER TO sandbox;
...
ALTER TABLE public.inventory OWNER TO sandbox;
...
ALTER TABLE public.language_language_id_seq OWNER TO sandbox;
...
ALTER TABLE public.language OWNER TO sandbox;
...
ALTER TABLE public.nicer_but_slower_film_list OWNER TO sandbox;
...
ALTER TABLE public.payment_payment_id_seq OWNER TO sandbox;
...
ALTER TABLE public.payment OWNER TO sandbox;
...
ALTER TABLE public.payment_p2022_01 OWNER TO sandbox;
...
ALTER TABLE public.payment_p2022_02 OWNER TO sandbox;
...
ALTER TABLE public.payment_p2022_03 OWNER TO sandbox;
...
ALTER TABLE public.payment_p2022_04 OWNER TO sandbox;
...
ALTER TABLE public.payment_p2022_05 OWNER TO sandbox;
...
ALTER TABLE public.payment_p2022_06 OWNER TO sandbox;
...
ALTER TABLE public.payment_p2022_07 OWNER TO sandbox;
...
ALTER TABLE public.rental_rental_id_seq OWNER TO sandbox;
...
ALTER TABLE public.rental OWNER TO sandbox;
...
ALTER TABLE public.rental_by_category OWNER TO sandbox;
...
ALTER TABLE public.sales_by_film_category OWNER TO sandbox;
...
ALTER TABLE public.staff_staff_id_seq OWNER TO sandbox;
...
ALTER TABLE public.staff OWNER TO sandbox;
...
ALTER TABLE public.store_store_id_seq OWNER TO sandbox;
...
ALTER TABLE public.store OWNER TO sandbox;
...
ALTER TABLE public.sales_by_store OWNER TO sandbox;
...
ALTER TABLE public.staff_list OWNER TO sandbox;
